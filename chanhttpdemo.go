...
fmt.Println(demo.url,rsp.StatusCode)
	if err!=nil{
		fmt.Println(err)
	}
	...
	demo.amount++
	fmt.Println(demo.url,endtime,demo.totalduration,len(demo.ch))
...
b,s,bi:=Newdemo("https://www.baidu.com/"),Newdemo("https://www.sina.com/"),Newdemo("https://www.bilibili.com/")
	...
	for i := 0; i < Retriesamounts ; i++ {
		...
		//go gethttp("https://www.taobao.com/", baidu)
		//go gethttp("https://www.bilibili.com/", sina)
		go b.gethttp()
		go s.gethttp()
		go bi.gethttp()
